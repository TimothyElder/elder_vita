...
\def\myaddress{The Dartmouth Institute}
...
\setsansfont[Mapping=tex-text,
	Ligatures={Common},
	Colour=\dartmouthgreen]{Iosevka}

\setmonofont[Mapping=tex-text,Scale=0.72]{Iosevka}

\newfontface\scheader[SmallCapsFont={Georgia},SmallCapsFeatures={Letters=SmallCaps}]{Georgia}
...
\begin{minipage}[t]{2.95in}
 ...
 \href{https://sociology.uchicago.edu/}{\myaddress} \\ \myaffiliation \\ \vspace{-0.05in} Hanover, \textsc{NH} 03755}
...
\ind Postdoctoral Fellow, The Dartmouth Institute for Health Policy \& Clinical Practice, Dartmouth College, 2024-2026
...
\ind PhD, Sociology, University of Chicago, 2024.
...
\ind Timothy B. Elder and Austin C. Kozlowski. ``Status and Subfield: The Distribution of Sociological Specializations across Departments.'' doi: \texttt{\href{https://osf.io/preprints/socarxiv/h85tp/}{10.31235/osf.io/h85tp}} \\
	\strut\hspace{0.4in} \footnotesize \textbf{Under Review} at \textit{Poetics} \normalsize \\

\ind Timothy B. Elder ``Interdependence and Difference: Niche Construction and Collaboration in Medicine'' \\
...
\ind Timothy B. Elder ``The Operation Was Successful, and the Patient Died: Success and Failure in the Care of the Dying'' \\
